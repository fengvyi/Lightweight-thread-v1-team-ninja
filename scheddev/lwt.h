...
/* The composite sl threads */
struct lwt_sl_thread
{
    struct sl_thd* kthd_struct;
    struct list_head glb_head;
    struct list_head wait_head;
    struct list_head zombie_head;
    struct list_head pool_head;
    struct cc_queue ready_queue;
    int stack_alloc[4];
    void* stack_addr;
};
...
struct lwt_info_struct
{
    ...
    s32 sndrcv_len;
    s32 state;
    /* The kernel thread's structure - This is for identifying who I belong to */
    struct lwt_sl_thread* kthd;
};
...
typedef struct lwt_sl_thread* kthd_t;
/* End Typedef ***************************************************************/
...
void*       __lwt_stack_get(kthd_t kthd);
